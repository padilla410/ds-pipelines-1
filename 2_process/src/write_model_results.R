save_rmse_data <- function(file_out, eval_data) {
  readr::write_csv(eval_data, file = file_out) # path command was deprecated in readr 1.4.0
}

save_diagnostics <- function(file_out, eval_data) {
